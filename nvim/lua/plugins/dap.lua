...
return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>dE", function() dapui.eval(vim.fn.input "[Expression] > ") end, { desc = write_desc("[D]ebug[E]valuate Input") })
        vim.keymap.set("n", "<leader>dC", function() dap.set_breakpoint(vim.fn.input "[Condition] > ") end, { desc = write_desc("[D]ebug [C]onditional Breakpoint")})
        vim.keymap.set("n", "<leader>dU", function() require("dapui").toggle() end, { desc = write_desc("[D]ebug Toggle [U]I") })
        ...
        vim.keymap.set("n", "<leader>dh", function() dap.ui.widgets.hover() end, { desc = write_desc("[D]ebug: [H]over Variables") })
        vim.keymap.set("n", "<leader>dS", function() dap.ui.widgets.scopes() end , { desc = write_desc("[D]ebug [S]copes") })
