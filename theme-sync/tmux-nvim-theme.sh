#!/usr/bin/env bash
# Fork of catppuccin-tmux/catppuccin.tmux: identical status-line layout, but
# sources thm_* colors from tmux-palette.sh (generated by set-theme.sh from
# the active nvim theme) instead of a fixed catppuccin flavour file.

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PALETTE_FILE="$SCRIPT_DIR/tmux-palette.sh"
